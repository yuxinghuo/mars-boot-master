...
<!-- 显示用的    ement -->
  <a-layout class="layout" :class="[device]">
    ...
    <template v-if="layoutMode === 'sidemenu'">
      <!--  v-show="device === 'mobile'"   v-if="device === 'mobile'"  下次解决，v-if创不出来-->
      <a-drawer
      ...
      <!-- pc端  menu    v-show="device === 'desktop'"  v-if="device === 'desktop'"    -->
      <side-menu
...
<style lang="less">
  ...
  // 数据列表 样式
// ant-select-enabled ant-select-allow-clear
