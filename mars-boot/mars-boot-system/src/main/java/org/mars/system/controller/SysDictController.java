...
import org.mars.system.model.SysDictTree;
import org.mars.system.model.TreeSelectModel;
import org.mars.system.service.ISysDictItemService;
import org.mars.system.service.ISysDictService;
import org.mars.system.vo.SysDictPage;
...
public class SysDictController {
    ...
    public Result<IPage<SysDict>> queryPageList(SysDict sysDict,
        ...
        IPage<SysDict> pageList = sysDictService.page(page, Wrappers.<SysDict>lambdaQuery()
                .like(StrUtil.isNotBlank(sysDict.getDictName()), SysDict::getDictName, sysDict.getDictName())
                .like(StrUtil.isNotBlank(sysDict.getDictCode()), SysDict::getDictCode, sysDict.getDictCode())
