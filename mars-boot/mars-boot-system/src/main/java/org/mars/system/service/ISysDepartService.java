...
public interface ISysDepartService extends IService<SysDepart>{
     ...
     * @return
     */
    public List<DepartIdTreeModel> queryDepartIdTreeList(QueryWrapper<SysDepart> queryWrapper);
    ...
    /**
     *  根据当前用户所选部门查询,当前和下级所有部门IDS
     * @param orgCode
     * @return
     */
    List<String> getSubDepIdsByLoginUserOrgCode(String orgCode);
