...
import org.mars.base.extra.config.DataRuleEnum;
...
public class QueryGenerator {
	...
	/**
	 * 封装上方的QueryWrapper.initQueryWrapper
	 *
	 * @param <T>
	 * @return
	 */
    ...
    public static Map<String, SysPermissionDataRuleModel> getRuleMap() {
        ...
        if (list != null && list.size() > 0) {
            ...
            // 要排除的权限
            String[] excludeRules = excludeDataRules();
            for (SysPermissionDataRuleModel rule : list) {
                if (StrUtil.equalsAnyIgnoreCase(rule.getRuleValue(), excludeRules)) {
                    continue;
                }
    ...
    private static String[] excludeDataRules() {
        return ArrayUtil.toArray(EnumUtil.getNames(DataRuleEnum.class), String.class);
    }
