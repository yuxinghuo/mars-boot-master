...
public class XSSFilterUtil {
	// sql 关键字
	private static String[] SQL_PATTERNS = { "%", "select "," select", "insert", "delete", "from", "count\\(", "drop table",
			"update", "truncate", "asc\\(", "mid\\(", "char\\(", "xp_cmdshell", "exec", "master",
			"netlocalgroup administrators", "net user", //
			" or", "or ", //
			" and", "and " };
	// 网页html
	...
	public static String stripXss(String value, boolean isJson) {
