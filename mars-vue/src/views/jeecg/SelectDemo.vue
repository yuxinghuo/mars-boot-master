  ...
  <a-card :bordered="false" style="height:100%;padding-bottom:200px; ">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" :form="form">
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="富文本修改器" style="min-height: 300px">
              <j-editor v-model="jeditor.value"/>
            </a-form-item>
          </a-col>
          <a-col :span="12">富文本修改器(v-model)：{{ jeditor.value }}</a-col>
        </a-row>
...
sayHi('hello, world!')`
        ...
        jeditor: {
          value: '<h2 style="text-align: center;">富文本修改器</h2> <p>这里是富文本修改器。</p>'
        },
        jellipsis: {
